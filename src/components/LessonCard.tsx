...
export function LessonCard ({ lesson }:LessonCardProps) {
  ...
  return (
    <div className="relative">
      <div className="">
          <div style={{height: 'calc(100% + 4rem)', left: '2.125rem'}} className="absolute top-6  w-1 bg-secondary-300"></div>
          ...
          {lesson.desc && <div className="flex flex-col pt-1  gap-4">
            ...
            {lesson.slug && 
              <div className="flex justify-between items-center pb-2">
                <Link className='block bg-secondary-500 w-fit px-6 py-2 text-sm rounded-md text-slate-100 transition-all hover:scale-105' href={'/licao/' + lesson.slug}>Acessar conteúdo</Link>
                {lesson.partner && 
                  <div className="">
